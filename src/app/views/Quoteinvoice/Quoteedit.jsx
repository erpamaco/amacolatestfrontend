...
const InvoiceEditor = ({ isNewInvoice, toggleInvoiceEditor }) => {
  ...
  function cancelform() {
    ...
    if(s){
      routerHistory.push(navigatePath + `/quote/${id}/${s}/${t}`);
            ...
            <option value={item.price}>{item.price}</option>
                      ...
                      /> */}
                              <CurrencyTextField
                                ...
                                value={item?.purchase_price == 0.000 ? "" :item?.purchase_price}
                                label="Price"
                                size="small"
                                onKeyDown={(e) => {
                                  controlKeyPress(
...
{console.log("item?.purchase_price",item?.purchase_price)}
                        ...
                        >
                          <TextField
                            ...
                            type="text"
                            disabled={item.purchase_price == 0.000 ? true : false}
                            variant="outlined"
                            onKeyDown={(e) => {
                              controlKeyPress(
                                e,
              ...
              <div className="px-4 flex justify-end">
                <div className="flex ">
                  ...
                  <div>
                    ...
                    {console.log("margin_val",margin_val)}
                    <div>
                      <CurrencyTextField
                        className="w-full mb-4 "
