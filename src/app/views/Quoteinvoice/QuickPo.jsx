...
const [vatValue,setVatValue] = useState(15)
  ...
  const handleSubmit = (e) => {
    ...
    }else if(freight == null || !freight || freight == '0'){

      Swal.fire({
        title: 'Warning',
        type: 'warning',
        icon: 'warning',
        text: 'Please Select Freight',
      })
        .then((result) => {
        
        })
    }else if(inco_terms == null || !inco_terms || inco_terms == '0'){

      Swal.fire({
        title: 'Warning',
        type: 'warning',
        icon: 'warning',
        text: 'Please Enter Inco Terms',
      })
        .then((result) => {
          ...
          <ValidatorForm autocomplete="off" onSubmit={e => { e.preventDefault(); }} onError={(errors) => null}>
            ...
            <div className="px-4 flex justify-between">
              ...
              <div className="px-4 flex justify-end">
                <div className="flex " >
                  <div className="pr-12">
                    <p className="mb-8" style={{ position: 'relative', top: '-4px' }}>Total Amount ({currency_type}) </p>
