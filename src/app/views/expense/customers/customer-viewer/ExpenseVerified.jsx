...
const ExpenseVerified = () => {
  ...
  const routerHistory = useHistory();
   const [from_date_exv, setfrom_date_exv] = useState(moment(new Date()).format("MMM YYYY"));
...
const handleDateChange_Q = (date) => {
  if(localStorage.getItem("dataKeyState_exv")){
    setfrom_date_exv(moment(date).format("MMM YYYY"));
    localStorage.setItem("from_date_exv",moment(date).format("MMM YYYY"));
