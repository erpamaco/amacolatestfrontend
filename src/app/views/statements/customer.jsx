  ...
  useEffect(() => {
    ...
    url
      ...
      .then(({ data }) => {
        ...
        setfrom_date("01-01-" + new Date().getFullYear())
        setto_date(new Date())
        setparty_id('')
        setstatements(myArr);
        setresponse_data(myArr)
                      ...
                      <div className="px-4 mb-2 pl-4 pt-4 pb-8 flex justify-between">
                        ...
                        >
                          ...
                          <TableBody>
                            ...
                            {!party_id ? statements.filter((obj) => new Date(moment(obj[0].date).format('YYYY')).getTime() == new Date(curr_year).getTime()).map((item, index) => {
