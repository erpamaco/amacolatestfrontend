...
import PView from "./proformaInv";
import PTrash from "./proformainvtrash";
import { ValidatorForm } from "react-material-ui-form-validator";
import PendingListProf from './PendingprofInvList'
...
const SimpleMuiTable = () => {
  ...
  const tabList = ["PROFORMA INVOICE","PENDING INVOICES", "TRASH"];
  ...
  useEffect(() => {
    ...
    if(localStorage.getItem("dataKeyStateP")){
      setUserList(JSON.parse(localStorage.getItem("dataKeyStateP")));
      setLoad(false);
        ...
        customBodyRender: (value, tableMeta, updateValue) => {
          return (
            <div style={{ textAlign: "right" }} className="pr-8">
              <Link to={navigatePath + "/proformanewinvoice/" + tableMeta.rowData[7]}>
              ...
              {/* <Link to={"/proforma/rfq-form/rfqanalysis?id=" + tableMeta.rowData[0]}>
            <IconButton>
  ...
  const [proforma_Report, setproforma_Report] = useState([]);
  ...
  const handleReset = () => {
    ...
    localStorage.removeItem("from_date");
      localStorage.removeItem("to_date");
    localStorage.removeItem("dataKeyStateP")
    setUserList(
  ...
  const handleSubmit = () => {
    ...
    localStorage.setItem('dataKeyStateP', JSON.stringify(userList))
    ...
    <div>
      ...
      <div className="m-sm-30">
        <div className="mb-sm-30">
          <Breadcrumb
            routeSegments={[
              // { name: "Add new", path: "/proforma/rfq-form/Rfqform" },
              ...
              <Grid container spacing={2}>
                ...
                <Grid item >
                 <Button
                  ...
                  {localStorage.getItem("dataKeyStateP") &&<Button
                    color="error"
                    variant="outlined"
                ...
                <Grid item lg={3} xs={12}>
                  <div className="text-right">
                    <Link to={navigatePath + "/ProformaInvoiceCreate"}>
                      <Button
                        className="py-2"
                        variant="outlined"
                        color="primary"
