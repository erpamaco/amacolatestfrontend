...
const SimpleMuiTable = () => {
  ...
  const [from_date_q_a, setfrom_date_q_a] = useState(moment(new Date()).format("MMM YYYY"));
  ...
  const handleDateChange_Q_Year = (date) => {
    if(localStorage.getItem("dataKeyState_q_a")){
      setfrom_date_q_a(moment(date).format("YYYY"));
      localStorage.setItem("from_date_q_a",moment(date).format("YYYY"));
      ...
      setqdetails(datas);
      localStorage.setItem('dataKeyState_q_a', JSON.stringify(datas))
  ...
  const handleDateChange_Q = (date) => {
    if(localStorage.getItem("dataKeyState_q_a")){
      setfrom_date_q_a(moment(date).format("MMM YYYY"));
      localStorage.setItem("from_date_q_a",moment(date).format("MMM YYYY"));
      setqdetails(resetuserList)
      const datas = resetuserList.filter(
        (obj) =>
  ...
  const handleReset = () => {
    setfrom_date_q_a(new Date())
    
  
    localStorage.removeItem("from_date_q_a");
      
    localStorage.removeItem("dataKeyState_q_a")
    setqdetails(
  ...
  const handleSubmit = () => {
    const datas = resetuserList.filter(
  (obj) =>
    new Date(moment(obj.quote_date).format('MMM YYYY')).getTime() == new Date(from_date_q_a).getTime() 
    // new Date(obj.issue_date).getTime() <= new Date(to_date).getTime()
);
setqdetails(datas);
localStorage.setItem('dataKeyState_q_a', JSON.stringify(datas))
...
// console.log("dataKeyState",JSON.parse(localStorage.getItem("dataKeyState")))
  ...
  if(localStorage.getItem("from_date_q_a")){
    setfrom_date_q_a(localStorage.getItem("from_date_q_a"));
    ...
    url.get("sales-list").then(({ data }) => {
      ...
      // {
        if(localStorage.getItem("dataKeyState_q_a")){
          setqdetails(JSON.parse(localStorage.getItem("dataKeyState_q_a")));
          setLoad(false);
  ...
  return (
    ...
    <KeyboardDatePicker
                      ...
                      autoOk={true}
                      views={["month","year"]}
                      value={localStorage.getItem("from_date_q_a") ? localStorage.getItem("from_date_q_a") : from_date_q_a}
                      format="MMM yyyy"
    ...
    <KeyboardDatePicker
          ...
          {/* <Button
                  ...
                  {localStorage.getItem("dataKeyState_q_a") &&<Button
                    color="error"
                    variant="outlined"
