                ...
                <td>
                  ...
                  >
                    <Grid container spacing={3} className="p-4">
                      ...
                      <Grid className="pl-0 pb-4" xs={4} style={{marginLeft:"165px" }}>
                        <span style={{ fontWeight: 1000 }}>PURCHASE ORDER</span>
                        <br></br>
                        {po_number}
                      </Grid>
                      <Grid className="pl-2 pb-4 pr-3 mr-1" align="right" xs>
                  ...
                  >
                    <Grid container spacing={3} className="p-4">
                      ...
                      <Grid className="pl-2 pb-4" xs={2}  style={{marginLeft:"165px" }}>
