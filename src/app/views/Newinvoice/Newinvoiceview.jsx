...
const InvoiceViewer = ({ toggleInvoiceEditor }) => {
  ...
  console.log("user",user.permission.filter(obj => obj.type == "Component"))
  const user_perm = user.permission.filter(obj => obj.type == "Component").map((item)=>{
    return item.module
  });
  ...
  useEffect(() => {
    ...
    url.get("invoice/" + id).then(({ data }) => {
      // console.log("jaskke",data[0]?.bank);
      if (data) {
        // setBank(data[4]?.[0]);
        setBank(data[0]?.bank);
        document.title =
  ...
  const updateSidebarMode = (sidebarSettings) => {
    if (sidebarSettings.mode == "close") {
      ...
      localStorage.setItem("fpage","filinv");//for setting the state value as it is 
      // let activeLayoutSettingsName = settings.activeLayout + "Settings";
      // let activeLayoutSettings = settings[activeLayoutSettingsName];
      // updateSettings({
      //   ...settings,
            ...
            >
              ...
              {del ? (
                ...
                <>
                  ...
                  {user_perm.includes('Invoice print button') ? "": <><MenuItem onClick={() => handlePrinting()}>
                    PRINT INVOICE
                  </MenuItem></>}
                                ...
                                <div className="flex">
                                  <div className="pr-0">
                                    ...
                                    >
                                      ...
                                      <td style={{ height: "auto !important" }}>
                                        {bank?.name ? bank?.name : 'Saudi National Bank' }
                                        {/* Saudi National Bank */}
                                      </td>
                                    </tr>
                                    <tr
                                    ...
                                    >
                                      ...
                                      <td style={{ height: "auto !important" }}>
                                        {bank?.ac_no ? bank?.ac_no : '6000000242200'}
                                    ...
                                    >
                                      ...
                                      <td style={{ height: "auto !important" }}>
                                        {bank?.iban_no ? bank?.iban_no : 'SA3610000006000000242200' }
