...
const MemberEditorDialog = ({ uid, open, handleClose, catid, catList,catid2 }) => {
          ...
          .then(function (response) {
            ...
            Swal.fire({
              ...
              .then((result) => {
                ...
                url.get("sub-category/" + catid2).then(({ data }) => {
                  console.log("ssid",catid2)
