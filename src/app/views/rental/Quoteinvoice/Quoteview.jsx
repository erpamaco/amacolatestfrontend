...
const InvoiceViewer = ({ toggleInvoiceEditor, list = [],
  ...
  const [terms5, setterms5] = useState('')
  const [terms6, setterms6] = useState('')
  const [terms7, setterms7] = useState('')
  const [terms8, setterms8] = useState('')
  const [terms9, setterms9] = useState('')
  const [terms10, setterms10] = useState('')
  const [terms11, setterms11] = useState('')
  ...
  useEffect(() => {
    ...
    url.get("rental-sale-quotation/" + id).then(({ data }) => {
      console.log("merssi",data)
      if (s == "new") {
        settab(0)
      }
      else if (s == "draft") {
      ...
      const uniqueAddresses = Array.from(new Set(data[0]?.rental_quotation_details.map(a => a.index1)))
        .map(id => {
          return data[0]?.rental_quotation_details.find((a) => a.index1 === id)
        })
      ...
      let result = data[0]?.rental_quotation_details.filter(function (o1) {
      ...
      setterms1(data[0]?.terms1)
      setterms2(data[0]?.terms2)
      setterms3(data[0]?.terms3)
      setterms4(data[0]?.terms4)
      setterms5(data[0]?.terms5)
      setterms6(data[0]?.terms6)
      setterms7(data[0]?.terms7)
      setterms8(data[0]?.terms8)
      setterms9(data[0]?.terms9)
      setterms10(data[0]?.terms10)
      setterms11(data[0]?.terms11)
  ...
  const deletequote = () => {
    ...
    Swal.fire({
      ...
      if (result.value) {
        url.delete(`rental-sale-quotation/${id}`)
          .then(res => {
    ...
    <div className={clsx("invoice-viewer py-4", classes.invoiceViewer)}>
                  ...
                  <div className="pl-2 pt-5 flex justify-center" style={{ borderTop: '1px solid #ccc', }}>
                    ...
                    <div className="flex">
                      <div className="pl-0 px-0 mb-4 mr-24 justify-center">
                        <h1><strong> SALES QUOTATION</strong></h1>
                        {vat}
                      </div>
                    </div>
                  </div>
              ...
              {qid}
                  ...
                  <Box display="flex" p={1} bgcolor="background.paper" className="pl-2 pr-2 flex justify-between">
                    <Grid container spacing={3} className="p-4">
                      ...
                      <Grid className="pl-0 pb-4" xs={4}>
                        <span style={{ fontWeight: 1000 }}>LOCATION</span><br></br>
                        {city ? city : "---"}
                  ...
                  <Box display="flex" p={1} bgcolor="background.paper" className="px-2 flex justify-between">
                    <Grid container spacing={3} className="p-4">
                      <Grid className="pl-2 pb-0" xs={4} style={{ wordBreak: 'break-word' }}>
                        <span style={{ fontWeight: 1000 }}>EMAIL</span><br></br>
                    ...
                    <Table style={{ width: "100%", fontSize: '10pt', border: "none", fontFamily: 'Calibri',zIndex:'1000' }} className="pl-4" id="table" >
                      <TableHead style={{ backgroundColor: '#1d2257', display: 'table-row-group' }}>
                        <TableRow style={{ pageBreakInside: 'avoid' }} id="table">
                          ...
                          <TableCell className="px-0" style={{ border: "1px solid #ccc", fontFamily: "Calibri", width: 110, color: '#fff', fontWeight: 1000, fontSize: '11pt' }} align="center">Mob.Charges per Unit</TableCell>
                          <TableCell className="px-0" style={{ border: "1px solid #ccc", fontFamily: "Calibri", width: 110, color: '#fff', fontWeight: 1000, fontSize: '11pt' }} align="center">De-mob.Charges per Unit</TableCell>
                        </TableRow>
                      </TableHead>
                      <TableBody >
                ...
                //  pageBreakAfter: 'always', pageBreakBefore: 'always'
                    ...
                    <div style={{height:'533px',marginTop:'-60px'}} className="viewer__order-info pt-2 px-4 mb-2 flex justify-between" >
                      <div >
                        <div class="break" >
      ...
      <tr style={{ height: 5,    fontSize:'11pt',textAlign: 'left'}}>
              <td colspan={2}><li>This is a system generated quote and hence does not required any signature.</li></td>
                            ...
                            <td style={{ color: "red" }} colspan={2}>COMMERCIAL & GENERAL TERMS & CONDITION</td>
                            <tr style={{ height: 5, fontSize: '11pt', textAlign: 'left' }}>

                              <td style={{ fontSize: '11pt', color: '#1d2257', height: 20 }}>
                              &nbsp;&nbsp;&nbsp;1. <u>HIRE UNIT RENTAL CHARGES:</u>
                              </td>
                            ...
                            <tr style={{ height: 5, fontSize: '11pt', textAlign: 'left' }}>
                              ...
                              <td className="pl-4"><b>Single shift (260hrs.):</b>{terms1}</td>
                            </tr>
                            <tr style={{ height: 5, fontSize: '11pt', textAlign: 'left' }}>
                              <td ><p style={{ fontSize: 16, color: '#1d2257', paddingTop: 2 }}>&nbsp;&nbsp;&nbsp;2.&nbsp;&nbsp;{terms2}</p> </td>
                            
                            </tr>
                            <tr style={{ height: 5, fontSize: '11pt', textAlign: 'left' }}>
                              <td ><p style={{ fontSize: 16, color: '#1d2257', paddingTop: 2 }}>&nbsp;&nbsp;&nbsp;3.&nbsp;&nbsp;{terms3}</p> </td>
          
                            </tr>
                            <tr style={{ height: 5, fontSize: '11pt', textAlign: 'left' }}>
                              <td ><p style={{ fontSize: 16, color: '#1d2257', paddingTop: 2 }}>&nbsp;&nbsp;&nbsp;4.&nbsp;&nbsp;{terms4}</p> </td>

                            </tr>
                            <tr style={{ height: 5, fontSize: '11pt', textAlign: 'left' }}>
                              <td ><p style={{ fontSize: 16, color: '#1d2257', paddingTop: 2 }}>&nbsp;&nbsp;&nbsp;5.&nbsp;&nbsp;{terms5}</p> </td>
             
                            </tr>
                            <tr style={{ height: 5, fontSize: '11pt', textAlign: 'left' }}>
                              <td ><p style={{ fontSize: 16, color: '#1d2257', paddingTop: 2 }}>&nbsp;&nbsp;&nbsp;6.&nbsp;&nbsp;{terms6}</p> </td>
                             
                            </tr>
                            <tr style={{ height: 5, fontSize: '11pt', textAlign: 'left' }}>
                              <td ><p style={{ fontSize: 16, color: '#1d2257', paddingTop: 2 }}>&nbsp;&nbsp;&nbsp;7.&nbsp;&nbsp;{terms7}</p> </td>
                             
                            </tr>
                            <tr style={{ height: 5, fontSize: '11pt', textAlign: 'left' }}>
                              <td ><p style={{ fontSize: 16, color: '#1d2257', paddingTop: 2 }}>&nbsp;&nbsp;&nbsp;8.&nbsp;&nbsp;{terms8}</p> </td>
                     
                            </tr>
                            <tr style={{ height: 5, fontSize: '11pt', textAlign: 'left' }}>
                              <td ><p style={{ fontSize: 16, color: '#1d2257', paddingTop: 2 }}>&nbsp;&nbsp;&nbsp;9.&nbsp;&nbsp;{terms9}</p> </td>
                            </tr>
                            <tr style={{ height: 5, fontSize: '11pt', textAlign: 'left' }}>
                              <td ><p style={{ fontSize: 16, color: '#1d2257', paddingTop: 2 }}>&nbsp;&nbsp;&nbsp;10.&nbsp;&nbsp;{terms10}</p> </td>
                            </tr>
                            <tr style={{ height: 5, fontSize: '11pt', textAlign: 'left' }}>
                              <td ><p style={{ fontSize: 16, color: '#1d2257', paddingTop: 2 }}>&nbsp;&nbsp;&nbsp;11.&nbsp;&nbsp;{terms11}</p> </td>
                            </tr>
             ...
             Inco-Term {inco_terms}
                    ...
                    <TableHead style={{ backgroundColor: '#1d2257', display: 'table-row-group' }}>
                      <TableRow style={{ pageBreakInside: 'avoid' }} id="table">
                        <TableCell className="pr-0" style={{ border: "1px solid #ccc", width: "50px", fontFamily: "Calibri", color: '#fff', fontWeight: 1000, fontSize: '11pt' }} align="center" colspan="3">AMACO</TableCell>
                    
                        <TableCell className="px-0" style={{ border: "1px solid #ccc", fontFamily: "Calibri", color: '#fff', fontColor: '#fff', fontWeight: 1000, fontSize: '11pt' }} align="center" colspan="3">CLIENT</TableCell>
                    ...
                    <TableBody >
                          ...
                          <TableRow style={{ border: "1px solid #ccc", pageBreakInside: 'avoid' }}>
                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left",paddingLeft:"9px" }} colspan="3">
                              Preventive/periodic maintenance and consumables(lubricants, oil, tires etc.)
                            </TableCell>
                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left",paddingLeft:"9px"  }} colspan="3">
                            Food ,Accommodation & Transportation for operator/Driver. Fuel for Equipment/Crane/Vehicle<br /><hr></hr>Internal shifting of any Equipment/Crane/ from one place to another.                            </TableCell>
                          ...
                          <TableRow style={{ border: "1px solid #ccc", pageBreakInside: 'avoid' }}>
                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left",paddingLeft:"9px"  }} colspan="3">
                                   Necessary documents for preparation of ID for Operators/Driver & Equipment's/Vehicles/Cranes.<br /> A -FOR OPERATORS/DRIVERS: SAG License, Aramco/TUV ID, Residence Permit.<br /> B -FOR CRANE/EQUIPMENT/VEHICLE: Owner's certificate, Insurance, Third Party/Aramco certificate.                     
                            </TableCell>

                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left",paddingLeft:"9px"  }} colspan="3">
                              Gate passes and work permit.<br /><hr></hr>Offloading & loading for light equipment(Generators, Welding Machines, Air Compressors, Tower Light, Mini Compactor etc.)
                            </TableCell>
                          ...
                          <TableRow style={{ border: "1px solid #ccc", pageBreakInside: 'avoid' }}>
                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left",paddingLeft:"9px"  }} colspan="3">
                                PPE -For Operators/Drivers & Equipment/Crane/Vehicle.
                            </TableCell>

                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left",paddingLeft:"9px"  }} colspan="3">
                              Off-hire notice must be informed in advance 3 days prior at sales@amaco.com.sa
                            </TableCell>
                          ...
                          <TableRow style={{ border: "1px solid #ccc", pageBreakInside: 'avoid' }}>
                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left",paddingLeft:"9px"  }} colspan="3">
                            25/7 service by our day & night shift site in charge
                            </TableCell>

                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left",paddingLeft:"9px"  }} colspan="3">
                            Safety Orientation for operator/Driver
                            </TableCell>
                          ...
                          <TableRow style={{ border: "1px solid #ccc", pageBreakInside: 'avoid' }}>
                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left",paddingLeft:"9px"  }} colspan="3">
                              AMACO will provide mobile service team
                            </TableCell>

                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt' ,textAlign:"left",paddingLeft:"9px" }} colspan="3">
                            Providing free access, hard, level standing foundation for safe operation of the Equipment/Crane.
                            </TableCell>
                          ...
                          <TableRow style={{ border: "1px solid #ccc", pageBreakInside: 'avoid' }}>
                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left" ,paddingLeft:"9px" }} colspan="3">
                            Equipment/Crane/Vehicle Service:<br />A - In case of major breakdown AMACO will replace the machine within 72 hours.<br />B - In case of Minor break down AMACO will Service the machine within 24 hours.
                            </TableCell>

                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left",paddingLeft:"9px"  }} colspan="3">
                            Inspection for the machine & Safety induction for operator/driver must conduct immediately Once the equipment reaches at your site.<br /><hr></hr>In case of break down inform immediately by EMAIL
                            </TableCell>
                          ...
                          <TableRow style={{ border: "1px solid #ccc", pageBreakInside: 'avoid' }}>
                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left" ,paddingLeft:"9px" }} colspan="3">
                            Delivery of Equipment/Crane/Vehicle shall be within 3 Days from order & hire unit to be Delivered on site above 2010 Model
                            </TableCell>

                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left" ,paddingLeft:"9px" }} colspan="3">
                           Assist Crane for assembly & disassembly, Additional Lifting accessories & Spreader Beam, Engineering Drawing, Lifting Plans, Ground Preparation, Reinstatement upon completion& insurance for lifted goods.
                            </TableCell>
                          ...
                          <TableRow style={{ border: "1px solid #ccc", pageBreakInside: 'avoid' }}>
                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left" ,paddingLeft:"9px" }} colspan="3">
                           For every 30 machines we shall provide 1 Senior Coordinator <br />1 Assistant Coordinator <br /> 1 tire man & Driver
                            </TableCell>

                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt' ,textAlign:"left",paddingLeft:"9px" }} colspan="3">
                            Safety & Security for all Equipment/Crane/Vehicle & Materials.
                            </TableCell>
                          ...
                          <TableRow style={{ border: "1px solid #ccc", pageBreakInside: 'avoid' }}>
                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left",paddingLeft:"9px"  }} colspan="3">
                            We will repair mechanical breakdown; rental will not be charged during breakdown period. Claims for direct, indirect, or consequential losses due to such occurences will not be made against us.
                            </TableCell>

                            <TableCell className="pr-0" align="center" style={{ border: "1px solid #ccc", fontFamily: "Calibri", fontSize: '11pt',textAlign:"left",paddingLeft:"9px"  }} colspan="3">
                            Responsible fro any theft which takes place at site on spare parts, Materials Etc.
                            </TableCell>
           ...
           <TableRow  style={{border: "1px solid #ccc", pageBreakInside: 'avoid'}}>
                    ...
                    {caluclateamount(salesExpense,months.thirdMonth,"SALES")}
                      ...
                      <TableRow>
                        <TableCell className="pr-0" align="center" colspan={6} style={{ border: "0px solid #ccc", fontFamily: "Calibri", fontSize: '11pt', fontWeight: 1000, textAlign:"left" }} >
                        Furthermore, if you require any more clarification, please do not hesitate to call the undersigned.
                        </TableCell>
                      </TableRow>
