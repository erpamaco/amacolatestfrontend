...
const DocumentExpired = () => {
  ...
  const columnsDue = [
    ...
    {
      name: "id", // field name in the row object
      label: "MODEL NAME", // column title that will be shown in table
      options: {
        filter: true,
        customHeadRender: ({ index, ...column }) => {
          return (
    ...
    {
      name: "id", // field name in the row object
      label: "PLATE NUMBER", // column title that will be shown in table
      options: {
        filter: true,
        customHeadRender: ({ index, ...column }) => {
          return (
    ...
    },
    {
      ...
      options: {
        ...
        customHeadRender: ({ index, ...column }) => {
          return (
            <TableCell key={index} width={190} style={{ textAlign: "center" }}>
