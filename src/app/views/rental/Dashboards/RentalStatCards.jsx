    ...
    <Grid container spacing={3} className="mb-3">
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <small className="text-muted">MOBILIZED VALUE | NUMBER</small>
      ...
      <Grid item xs={12} md={4}>
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <small className="text-muted"> AVAILABLE EQUIPMENT</small>
      ...
      <Grid item xs={12} md={4}>
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <small className="text-muted">VEHICLE UNDER MAINTENANCE VALUE | NUMBER</small>
      ...
      <Grid item xs={12} md={4}>
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <small className="text-muted">VEHICLE OUTSOURCING</small>
