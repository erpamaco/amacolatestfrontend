...
*/
    url.get(`getAllRentalEquipments`).then(({ data }) => {
        ...
        customHeadRender: ({ index, ...column }) => {
          return (
            <TableCell key={index} style={{ width: 100, textAlign: 'center' }}>
              <span textAlign="center" >LOG.NO.</span>
            </TableCell>
          )
        },
        ...
        customBodyRender: (value, tableMeta, updateValue) => {
          ...
          return (
            ...
            >
              ...
              <Link style={{ textAlign: "right", paadingRight: 20 }} to={navigatePath + "/rental/singleequipment/" + tableMeta.rowData[7]}>
          ...
          data={
            userList.filter(obj => obj.div_id == localStorage.getItem('division')).map((item, index) => {
              ...
              return [
                ...
                item.equipment,
                item.model,
                moment(item.mfg_date).format("YYYY"),
                item.plate,
                item.capacity,
                item.comments,
                item.id,
